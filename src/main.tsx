...
// Route registry — all pages lazy-loaded for code splitting
...
/** Scrolls to top on route change — for a boutique feel. */
          ...
          <BrowserRouter basename={import.meta.env.BASE_URL}>
            ...
            <Routes>
              ...
              <Route
                path="/account"
                element={
                  <RequireAuth title="Sign in to view your orders" description="Your orders and measurements live here.">
                    <AccountPage />
                  </RequireAuth>
                }
              />
